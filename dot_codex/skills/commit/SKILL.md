...
4. If `git status` still reports changes, repeat from Step 1 and create additional commits until the working directory is clean, amending when something needs correction.
...
- Do not build or test the project before committing. You can safely assume that this has been done before.
